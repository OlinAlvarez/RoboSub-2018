...
class FrontCamDistance {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FrontCamDistance(null);
  ...
  static datatype() {
    ...
    return 'computer_vision/FrontCamDistance';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FrontCamDistance(null);
...
module.exports = FrontCamDistance;
